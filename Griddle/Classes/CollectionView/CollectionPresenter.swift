      ...
      for cell in map.registrationItems {
         ...
         case .nib(let nib):
            if cell.itemType != .row {
               ...
               collectionView.register(nib, forSupplementaryViewOfKind: kind, withReuseIdentifier: cell.identifier)
            } else {
         ...
         case .viewClass(let cellClass):
            if cell.itemType != .row {
               let kind = cell.itemType == .header ? UICollectionElementKindSectionHeader : UICollectionElementKindSectionFooter
               collectionView.register(cellClass, forSupplementaryViewOfKind: kind, withReuseIdentifier: cell.identifier)
            } else {
